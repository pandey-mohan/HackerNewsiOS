...
class SlidingContainerViewController: UIViewController, UIScrollViewDelegate, SlidingContainerSliderViewDelegate {
    ...
    init (parent: UIViewController, contentViewControllers: [UIViewController], titles: [String], frame : CGRect) {
        ...
        sliderView.autoresizingMask = []
        sliderView.autoresizingMask =  [.flexibleWidth, .flexibleBottomMargin]
        contentScrollView = UIScrollView (frame: CGRect(x: 0, y: 0, width: view.frame.size.width, height: view.frame.size.height))
        ...
        contentScrollView.autoresizingMask = []
        ...
        for vc in contentViewControllers {
            vc.view.frame = CGRect (
                x: currentX,
                y: sliderView.frame.size.height,
                width: view.frame.size.width,
                height: view.frame.size.height - sliderView.frame.size.height)

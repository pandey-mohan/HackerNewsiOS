...
{
    if([propertyName isEqualToString:@"itemImageRec"])
    {
        return @"ItemImageModel";
    }
    
    if([propertyName isEqualToString:@"cliList"])
    {
        return @"ConversationListItem";
    }
    if([propertyName isEqualToString:@"convList"])
    {
        return @"Conversation";
    }
//    if([propertyName isEqualToString:@"records"])
//    {
//        return @"BrandModel";
//    }
